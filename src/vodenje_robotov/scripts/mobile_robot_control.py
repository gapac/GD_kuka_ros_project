...
class MobileRobotControl():
    ...
    def __init__(self, robot_name="YouBot"):
        ...
        self.sick_laser_subscriber = rospy.Subscriber('/scan', LaserScan, self.laser_callback)
    ...
    def _check_laser_ready(self):
        self.laser_msg = None
        rospy.loginfo("Checking LIDAR laser...")
        ...
        rospy.loginfo("Checking LIDAR...DONE")
    ...
    def move_straight(self, x: float, rot: float):
    ...
    def move_straight_turn(self, trans_speed, rot_speed, time):

        # Initilize velocities
        self.cmd.linear.x = trans_speed
        self.cmd.linear.y = 0
        self.cmd.linear.z = 0
        self.cmd.angular.x = 0
        self.cmd.angular.y = 0
        self.cmd.angular.z = rot_speed
