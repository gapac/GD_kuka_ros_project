...
struct JointAccelerations_
{
  ...
  _poisonStamp_type poisonStamp;
   ...
   typedef std::vector< ::brics_actuator::JointValue_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::brics_actuator::JointValue_<ContainerAllocator> >> _accelerations_type;
