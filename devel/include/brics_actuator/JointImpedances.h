...
struct JointImpedances_
{
  ...
  _poisonStamp_type poisonStamp;
   ...
   typedef std::vector< ::brics_actuator::JointValue_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::brics_actuator::JointValue_<ContainerAllocator> >> _dampings_type;
  _dampings_type dampings;

   typedef std::vector< ::brics_actuator::JointValue_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::brics_actuator::JointValue_<ContainerAllocator> >> _stiffnesses_type;
