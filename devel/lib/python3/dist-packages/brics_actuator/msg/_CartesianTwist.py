...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.base_frame_uri = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.target_frame_uri = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.translation.unit = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.rotation.unit = str[start:end].decode('utf-8', 'rosmsg')
      else:
